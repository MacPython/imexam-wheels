##################
imexam wheel builder
##################

Repository to build imexam wheels.
...
* Update imexam submodule with version you want to build:

    * cd imexam && git pull && git checkout DESIRED_COMMIT
    * cd .. && git add imexam
    * git commit
